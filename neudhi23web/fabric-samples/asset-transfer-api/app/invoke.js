...
// CreateAsset ========Working================
 ...
 if (fcn === "TransferAsset" || fcn === "TransferAsset"
            ...
            message = `Successfully ${args[0]} Is Transfer And New Owner Is ${args[1]}`
...
// InitLedger
 ...
 if (fcn === "InitLedger" || fcn === "InitLedger"
            ...
            message = `Successfully  InitLedger${args[0]}`
...
// GetAllAssets==================Working================
            ...
            if (fcn === "GetAllAssets" || fcn === "GetAllAssets"
                   || fcn == "GetAllAssets") {
            result = await contract.submitTransaction(fcn, args[0]);
            message = `Successfully Get-All-Assets ${args[0]}`
...
//ReadAsset=========Working================
        ...
        if (fcn === "ReadAsset" || fcn === "ReadAsset"
                   || fcn == "ReadAsset") {
        result = await contract.submitTransaction(fcn, args[0]);
        message = `Successfully ReadAsset  ${args[0]}`
